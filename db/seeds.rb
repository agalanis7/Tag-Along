...
biking_trail   = Location.create(name: "Amelia Earhart Park", street: "401 E 65th St", city: "Hieleah", state: "Fl", country: "USA")
biking_trail_1 = Location.create(name: "Virginia Key North Point Trails", street: "Arthur Lamb Jr Rd,", city: "Miami", state: "Fl", country: "USA")
biking_trail_2 = Location.create(name: "Brickell Key Park", street: "Brickell Key Dr", city: "Miami", state: "Fl", country: "USA")
biking_trail_3 = Location.create(name: "Oleta River State Park", street: "3400 NE 163rd St", city: "Miami", state: "Fl", country: "USA")
